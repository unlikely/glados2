...
describe Person do
  ...
  describe "associations are present and" do
    ...
    it "has_many :possession_contracts if a person owns :equipment" do
      ...
      pos_contract  = PossessionContract.new(person: person, equipment: Equipment.new(make: "vw", model: "jetta"), contract_type: "lease")
      pos_contract2 = PossessionContract.new(person: person, equipment: Equipment.new(make: "dewalt", model: "drill"), contract_type: "lease")
